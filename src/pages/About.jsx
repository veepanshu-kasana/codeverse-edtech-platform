...
export const About = () => {
  return (
    <div>
            ...
            <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between
             gap-10 text-center text-white'>
                ...
                <div className='absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%]
                 translate-y-[30%] grid-cols-3 gap-3 lg:gap-5'>
             ...
             gap-10 text-richblack-500'>
                ...
                <div className='flex flex-col items-center gap-10 lg:flex-row justify-between'>
                    ...
                    <div className='my-24 flex lg:w-[50%] flex-col gap-10'>
                        ...
                        <h1 className='bg-gradient-to-br from-[#833AB4] via-[#FD1D1D]
                         to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%]'>
                            Our Founding Story
                        </h1>
        ...
        {/* Section 5 */}
        <section className='mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col
