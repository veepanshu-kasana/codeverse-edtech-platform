                    ...
                    <div className='w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0'>
                        ...
                        <div className='flex flex-col gap-2'>
                            {["About", "Careers", "Affiliates"].map(
                                (ele, i) => {
                                    return (
                                        <div key={i} className='text-[14px] cursor-pointer hover:text-richblack-50
                    ...
                    <div className='w-[48%] lg:w-[30%] mb-7 lg:pl-0'>
                        ...
                        <div className='flex flex-col gap-2 mt-2'>
                            {Resources.map((ele, index) => {
                                return (
                                    <div key={index} className='text-[14px] cursor-pointer hover:text-richblack-50
                                     transition-all duration-200'>
         ...
         mx-auto pb-14 text-sm'>
            ...
            <div className='flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full'>
                ...
                <div className='text-center'>
                    Made with ❤️ Veepanshu Kasana © 2025 CodeVerse
                </div>
